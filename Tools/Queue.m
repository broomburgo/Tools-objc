...
- (void)executeAsynchronously:(BOOL)async after:(double)seconds task:(Task)task {
...
- (void)sync:(Task)task {
    [self executeAsynchronously:NO after:0 task:task];
}

- (void)async:(Task)task {
    [self executeAsynchronously:YES after:0 task:task];
}

- (void)after:(double)seconds task:(Task)task {
    [self executeAsynchronously:YES after:seconds task:task];
}
